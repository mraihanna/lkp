  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Range Date</h4>
            <p class="card-description">
            <div class="col-lg-6 offset-lg-3">
              <div class="row justify-content-center mb-1">
                <input type="date" class="form-control col-4" name="tanggal" id="tanggal" value="<?= date('Y-m-d', strtotime(set_value('tanggal'))); ?>">
                <h5 class="col-4 d-flex justify-content-center my-auto">Until</h5>
                <input type="date" class="form-control col-4" name="tanggal" id="tanggal" value="<?= date('Y-m-d', strtotime(set_value('tanggal'))); ?>">
              </div>
            </div>
            <div class="col-lg-6 offset-lg-3">
              <div class="row d-flex justify-content-center">
                <select class="js-example-basic-single w-100" name="target">
                  <?php if ($countSubordinate < 0) : ?>
                    <option value="all">-Semua-</option>
                  <?php else : ?>
                    <option hidden disabled selected>-Not Have Subordinate-</option>
                  <?php endif; ?>
                  <?php foreach ($subordinate as $s) : ?>
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">History Report</h4>
            <p class="card-description">
                ...
                <tbody>
                  ...
                  foreach ($employee as $e) : ?>
                    <tr>
                      ...
                      <td> <?= htmlentities($e['is_active']) == 1 ? "<div class = 'badge badge-success'> Diterima </div>" : "<div class = 'badge badge-danger'> Dalam Proses </div>"; ?> </td>
                      <td>
